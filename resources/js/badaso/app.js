...
import api from "./vendor/badaso/core/src/resources/js/api/index";
import handleError from "./vendor/badaso/core/src/resources/js/api/handle-error";
import resource from "./vendor/badaso/core/src/resources/js/api/resource";
import router from "./vendor/badaso/core/src/resources/js/router/router";
import store from "./vendor/badaso/core/src/resources/js/store/store";
import lang from "./vendor/badaso/core/src/resources/js/lang/";
import excludedRouter from "./vendor/badaso/core/src/resources/js/router/excludeRouter";

import App from "./apps/App.vue";

import firebase from "firebase/app";
import "firebase/firebase-messaging";
import { notificationMessageReceiveHandle } from "./vendor/badaso/core/src/resources/js/utils/firebase";
import { broadcastMessageHandle } from "./vendor/badaso/core/src/resources/js/utils/broadcast-messages";
import { checkConnection } from "./vendor/badaso/core/src/resources/js/utils/check-connection";
import { readObjectStore, setObjectStore } from "./vendor/badaso/core/src/resources/js/utils/indexed-db";
